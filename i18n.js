...
(function () {
  ...
  var sharedTranslations = {
    en: {
      ...
      projectsTranslating: 'Translating…',
      projectsAccuracyWarningTitle: 'Translation Accuracy',
      projectsAccuracyWarningText: 'Please note that translations are automatically generated and may not be 100% accurate compared to the original English content.',
      projectsAccuracyGotIt: 'Got it',
    ...
    pt: {
      ...
      projectsTranslating: 'A traduzir…',
      projectsAccuracyWarningTitle: 'Precisão da Tradução',
      projectsAccuracyWarningText: 'Tenha em conta que as traduções são geradas automaticamente e podem não ser 100% precisas em relação ao conteúdo original em inglês.',
      projectsAccuracyGotIt: 'Entendi',
    ...
    es: {
      ...
      projectsTranslating: 'Traduciendo…',
      projectsAccuracyWarningTitle: 'Precisión de la traducción',
      projectsAccuracyWarningText: 'Ten en cuenta que las traducciones se generan automáticamente y pueden no ser 100% precisas en comparación con el contenido original en inglés.',
      projectsAccuracyGotIt: 'Entendido',
    ...
    hi: {
      ...
      projectsSubtitle: 'सीखते समय बनाई गई चीज़ें।',
      projectsStatusCompleted: 'पूर्ण',
      projectsStatusInProgress: 'चल रहा है',
      projectsStatusPlanned: 'योजना',
      projectsOverlayType: 'प्रोजेक्ट',
      projectsOverlayYear: 'वर्ष',
      projectsLinkRepo: 'स्रोत देखें',
      projectsLinkLive: 'लाइव डेमो',
      projectsEmpty: 'अभी कोई प्रोजेक्ट नहीं।',
      projectsLoading: 'प्रोजेक्ट लोड हो रहे हैं…',
      projectsErrorLoading: 'प्रोजेक्ट लोड नहीं हो सके। सुनिश्चित करें कि data/projects.json मौजूद है।',
      projectsCountSingular: 'प्रोजेक्ट',
      projectsCountPlural: 'प्रोजेक्ट',
      projectsImagePlaceholder: 'कोई पूर्वावलोकन नहीं',
      projectsTranslating: 'अनुवाद हो रहा है…',
      projectsAccuracyWarningTitle: 'अनुवाद की सटीकता',
      projectsAccuracyWarningText: 'कृपया ध्यान दें कि अनुवाद स्वचालित रूप से जेनरेट होते हैं और मूल अंग्रेज़ी सामग्री की तुलना में 100% सटीक नहीं हो सकते।',
      projectsAccuracyGotIt: 'समझ गया',
    ...
    zh: {
      ...
      projectsTranslating: '正在翻译…',
      projectsAccuracyWarningTitle: '翻译准确性',
      projectsAccuracyWarningText: '请注意，翻译为自动生成，可能与原始英文内容并非 100% 一致。',
      projectsAccuracyGotIt: '知道了',
