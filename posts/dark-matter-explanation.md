...
Using the Newtonian gravity equation, the stars that are further should rotate slower than what we saw on observations:
...
M = Mass of the body
R = Radius (Distance of rotation center)

So, velocity and gravity are basically connected

- If a body is being attracted by a larger body it will be faster, because gravity pull is stronger.
-  If a body is being attracted by a smaller body it will be slower, because gravity pull is weaker.

But we notice that it does not happen. Stars far away still rotate faster then what was predicted by newtons law, and the explanation we haves is that, there is some type of particle unseen mass adding extra gravity for those stars, to make them rotate faster.

![[Code_Generated_Image.png|573]]

### Strong gravitational lensing using it as evidence

We can see it too using a process called, strong gravitational lensing, so basically, when light passes by a mass, its path curves, a straight line in a curved space. Light that would pass near a galaxy cluster instead bends toward and around it, producing intensified and multiple images of background source. And using that we can provide a way to determine the location and quantity of it in galaxy clusters.

![[Pasted image 20260620003553.png|234]]
...
There is a giant list of experiments to try to detect dark matter, so I will not list it in here, but if you want to see it here is the URL to the website that explains it:

- https://www.americanscientist.org/article/searching-for-dark-matter

Sources :

[https://science.nasa.gov/dark-matter/](https://science.nasa.gov/dark-matter/)
[https://www.reddit.com/r/cosmology/comments/1c2mmlp/what_exactly_is_dark_energy_and_dark_matter/](https://www.reddit.com/r/cosmology/comments/1c2mmlp/what_exactly_is_dark_energy_and_dark_matter/)

[https://home.cern/science/physics/dark-matter/](https://home.cern/science/physics/dark-matter/)

[https://spaceplace.nasa.gov/dark-matter/en/](https://spaceplace.nasa.gov/dark-matter/en/)

[https://www.scribd.com/doc/239499588/14-O-momento-angular-Dos-Corpos-Celestes](https://www.scribd.com/doc/239499588/14-O-momento-angular-Dos-Corpos-Celestes)

[https://mundoeducacao.uol.com.br/fisica/momento-angular.htm](https://mundoeducacao.uol.com.br/fisica/momento-angular.htm)

[https://hetdex.org/what-is-dark-energy/dark-energy-vs-dark-matter/](https://hetdex.org/what-is-dark-energy/dark-energy-vs-dark-matter/)
