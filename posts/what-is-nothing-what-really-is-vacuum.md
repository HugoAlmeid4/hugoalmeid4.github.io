---
title: What is "nothing", what really is vacuum?
date: 2026-07-07
...
In quantum field theory, vacuum is described as the lowest energy state of the field,[[1]](#fn-1), it is basically a volume empty of matter. Only partial vacuums [[2]](#fn-2) are possible

### How can vacuum be something if it does not contain any matter?

While perfect vacuum[[3]](#fn-3) does not contain any matter to be considered, (atoms), we consider it as something, because while it does not have atoms it has quantum fields, which mean they are not truly empty.

But, space vacuum[[4]](#fn-4) is not the same as perfect vacuum, because it has some atoms, they are just extremely far apart from each other.
...
The difference between light and sound traveling through vacuum is one and is not that hard to understand, unlike sound, light does not need a medium to travel. An electromagnetic wave consists of oscillating electric and magnetic fields, and those travel together as a transverse wave, and both allow the light to propagate through vacuum oscillating together.

![Electromagnetic Waves Image](elctromagnetic-waves.png "Electromagnetic Waves Image")
...
[NPL](https://www.npl.co.uk/resources/q-a/what-is-a-vacuum)
[Dictionary](https://www.dictionary.com/browse/partial-vacuum)
